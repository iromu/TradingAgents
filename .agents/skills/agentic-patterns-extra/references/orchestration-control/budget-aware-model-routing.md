...
id: budget-aware-model-routing
summary: >-
  Route agent requests to tiered models with explicit budget contracts and hard
  caps, with deterministic fallback and quality override paths.
