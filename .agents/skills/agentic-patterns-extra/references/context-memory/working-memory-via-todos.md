...
summary: >-
  Use TodoWrite to maintain explicit working memory throughout sessions, tracking
  task status, dependencies, and progress for both agent and user visibility.
