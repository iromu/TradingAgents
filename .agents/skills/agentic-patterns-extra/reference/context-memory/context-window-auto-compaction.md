...
summary: >-
  Automatic session compaction triggered by context overflow errors, with smart
  reserve tokens and lane-aware retry to preserve essential information while
