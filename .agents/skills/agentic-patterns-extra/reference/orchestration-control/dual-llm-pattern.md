...
id: dual-llm-pattern
summary: >-
  Split roles between a privileged LLM (plans and calls tools, never sees raw
  untrusted data) and a quarantined LLM (reads untrusted data, zero tool access)
  to establish clear trust boundaries.
