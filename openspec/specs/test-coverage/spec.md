...
Ensure comprehensive test coverage across the TradingAgents system by adding unit tests for core agent actions and researchers, integration tests for the full pipeline and individual agents, and tests for prompt file loading and helper methods.
